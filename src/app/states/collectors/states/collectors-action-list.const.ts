export enum CollectorsActionList {
  GET_COLLECTORS = '[Collectors] get collectors request',
  GET_COLLECTORS_SUCCESS = '[Collectors] get collectors success',
  GET_COLLECTORS_FAIL = '[Collectors] get collectors fail',
