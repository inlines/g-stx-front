...
export class OnboardingComponent implements OnInit, OnDestroy {
  ...
  readonly steps = [
    ...
    { name: 'По фото', title: 'Найдите игру по торцу коробки', text: 'Откройте «По фото». Снимите напечатанный серийник прямо, крупно и без бликов. Загрузите фото, при необходимости поверните его, коснитесь кода и настройте рамку ползунками. Нажмите «Распознать», проверьте буквы и цифры и выберите консоль. Если текст не читается — загрузите другой снимок или введите код вручную.', action: 'Найти по коду', result: 'Каталог откроется с названием найденной игры, консолью и регионом её релиза — можно сразу открыть карточку. При нескольких совпадениях сначала выберите подходящий регион. Штрихкод без напечатанного серийника не используется.', scene: 10 },
