...
export class OnboardingComponent implements OnInit, OnDestroy {
  ...
  readonly steps = [
    { ...this.originalSteps[0], scene: 0 },
    {
      ...
      text: 'Сначала выберите консоль. Затем выберите регионы. Раскройте «Мультиплеер и жанр», чтобы уточнить фильтры; в свёрнутом виде видно число выбранных. «Пропустить цифровые» скрывает отмеченные digital-only игры. Для будущих игр включите «Показывать невышедшие». Ищете конкретный диск? Переключите поиск на серийник и введите его целиком.',
